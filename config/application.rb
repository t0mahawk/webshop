...
module Depot
  class Application < Rails::Application
	...
	$DEFAULT_RATE = 150 # default conversion rate, Euro to BTC, in application_helper, in case of json error.
	$MARGIN_RATE = 1.20 # margin over Bitcoin Charts EUR/BTC average rate
