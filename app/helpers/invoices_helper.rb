...
require 'prawn/qrcode'
 ...
 def count_lines_from_string(string)
    ...
    if @invoice.pay_type == "check"
     ...
     thanks = case I18n.locale.to_s
      ...
      delivery = case I18n.locale.to_s
              when 'en' then "Delivery Address: "
              when 'fr' then "Adresse de livraison: "
    ...
    Prawn::Document.generate("#{::Rails.root.to_s}/tmp/#{btc_address}.pdf") do
      ...
      logopath = "#{::Rails.root.to_s}/public/images/microbitcoin_banner_print.png" # warning: Prawn does NOT handle interlace png image
